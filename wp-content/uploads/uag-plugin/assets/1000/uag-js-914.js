document.addEventListener("DOMContentLoaded", function(){ jQuery(document).ready(function () {
				let scope = jQuery(".wp-block-uagb-image-gallery.uagb-block-ff6c9171");
				if ( scope.length ) { 
				...
				let scope = jQuery(".wp-block-uagb-image-gallery.uagb-block-25e466d2");
				if ( scope.length ) { 
					scope.css("visibility", "visible");
					let getSlickCarousel = scope.find(".uagb-slick-carousel");
					if( getSlickCarousel.length ) {
				...
				let scope = jQuery(".wp-block-uagb-image-gallery.uagb-block-5c1e26e7");
				if ( scope.length ) { 
					scope.css("visibility", "visible");
					let getSlickCarousel = scope.find(".uagb-slick-carousel");
					if( getSlickCarousel.length ) {
